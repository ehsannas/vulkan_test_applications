...
@gapit_test("vkGetSwapchainImagesKHR_test.apk")
class GetSwapchainImages_test(GapitTest):
    ...
    def expect(self):
        ...
        require(
            swapchain_images.get_write_data(
                swapchain_images.hex_PSwapchainImages, num_swapchain_images *
        ...
        if num_swapchain_images > 1:
            ...
            require(
                swapchain_images.get_write_data(
                    ...
                    (num_swapchain_images - 1) * NON_DISPATCHABLE_HANDLE_SIZE))
