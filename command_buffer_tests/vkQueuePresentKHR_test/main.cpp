...
int main_entry(const entry::entry_data* data) {
  ...
  vulkan::VkDevice& device = app.device();
  {
    ...
    SetImageLayout(raw_image_to_present, VK_IMAGE_LAYOUT_UNDEFINED,
                   VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, &cmd_buf,
                   &app.present_queue(), VK_IMAGE_ASPECT_COLOR_BIT);
    ...
    SetImageLayout(raw_image_to_present, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                   VK_IMAGE_LAYOUT_PRESENT_SRC_KHR, &cmd_buf,
                   &app.present_queue(), VK_IMAGE_ASPECT_COLOR_BIT,
