...
int main_entry(const entry::entry_data* data) {
...

  {
    ...
    // TODO(qining): un-comment the code below once the bug is fixed or the
    // skip device list be updated.
    // IF_NOT_DEVICE(data->log, device, vulkan::PixelC, 0x5A400000) {
    //   device->vkDestroyImageView(device, (VkImageView)VK_NULL_HANDLE,
    //   nullptr);
    // }
  }
